...
UNUSED_LIST = [line.strip() for line in open( 'src-mods/build/conf_make/make_unused.txt' )]
for Unfile in UNUSED_LIST:
...
MODS_LIST = [line.strip() for line in open( 'src-mods/build/conf_make/make_mods_list.txt' )]
...
for mod in MODS_LIST :
	...
	zip(RESULT_DIR + "/Client/" + mod, RESULT_DIR2 + "/Client/" + mod)
