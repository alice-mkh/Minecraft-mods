...
label0:
        ...
        for(int intk1 = 0; intk1 < intf22; intk1++)
        {
            ...
            if(blocks[(j2 * length + i6) * width + i2] == 0){
        ...
        for(int i8 = 0; i8 < width; i8++)
        {
            ...
            for(int j4 = 0; j4 < length; j4++)
            {
                ...
                int k14 = blocks[((i12+1) * length + j4) * width + i8] & 0xff;
        ...
        for(i2 = 0; i2 < k1; i2++)
        {
            ...
            for(int k4 = 0; k4 < 10; k4++)
            {
                ...
                for(int j12 = 0; j12 < 5; j12++)
                {
                    ...
                    boolean flag2;
                    if(!(flag2 = (blocks[(k13 * length + l10) * width + l9] & 0xff) == 0))
                        continue;
                    int j15 = (k13 * length + l10) * width + l9;
                    int l15;
                    if((l15 = blocks[((k13 - 1) * length + l10) * width + l9] & 0xff) != Block.grass.blockID)
                        continue;
                    if(k2 == 0)
                    {
        ...
        for(int l2 = 0; l2 < i2; l2++)
        {
            ...
            for(int i11 = 0; i11 < 20; i11++)
            {
                ...
                for(int k15 = 0; k15 < 5; k15++)
                {
                    ...
                    boolean flag3;
                    if(k6 >= 2 && rand.nextInt(4) != 0 || k12 < 0 || l14 < 0 || l13 < 1 || k12 >= width || l14 >= length || l13 >= arrayf1[k12 + l14 * width] - 1 || !(flag3 = (blocks[(l13 * length + l14) * width + k12] & 0xff) == 0))
                        continue;
                    int i16 = (l13 * length + l14) * width + k12;
                    int j1;
                    if((j1 = blocks[((l13 - 1) * length + l14) * width + k12] & 0xff) != Block.stone.blockID)
                        continue;
                    if(k6 == 0)
                    {
