...
public abstract class BiomeGenBase
{
    ...
    /** Taiga Hills biome. */
    public static final BiomeGenBase taigaHills = (new BiomeGenTaiga(19)).setColor(0x163933).setBiomeName("TaigaHills").setEnableSnow().func_4080_a(0x4eba31).setTemperatureRainfall(0.05F, 0.8F).setMinMaxHeight(0.2F, 0.7F);
    ...
    public static final BiomeGenBase betaForest = (new BiomeGenForest(33)).setColor(0x56621).setBiomeName("Beta Forest").setTemperatureRainfall(0.7F, 0.75F).func_4080_a(0x4eba31);
    ...
    public static final BiomeGenBase betaTaiga = (new BiomeGenDesert(36)).setColor(0x2eb153).setBiomeName("Beta Taiga").setTemperatureRainfall(0.2F, 0.5F).func_4080_a(0x7bb731);
    ...
    public static final BiomeGenBase betaIceDesert = (new BiomeGenDesert(39)).setColor(0xffed93).setBiomeName("Beta Ice Desert").setTemperatureRainfall(0.2F, 0.1F).func_4080_a(0xc4d339).setEnableSnow().setDisableRain();
    public static final BiomeGenBase betaTundra = (new BiomeGenSnow(40)).setColor(0x57ebf9).setBiomeName("Beta Tundra").setTemperatureRainfall(0.1F, 0.1F).func_4080_a(0xc4d339).setEnableSnow();
