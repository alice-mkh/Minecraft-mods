...
public class GenLayerSmoothZoom11 extends GenLayer
{
    public GenLayerSmoothZoom11(long l, GenLayer genlayer)
    {
        super(l);
        parent = genlayer;
    }
    ...
    public static GenLayer func_35517_a(long l, GenLayer genlayer, int i)
    {
        ...
        for (int j = 0; j < i; j++)
        {
            obj = new GenLayerSmoothZoom11(l + (long)j, ((GenLayer) (obj)));
        }
