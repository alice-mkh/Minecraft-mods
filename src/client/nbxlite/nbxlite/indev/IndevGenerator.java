...
label0:
        ...
        if (mod_noBiomesX.GenerateNewOres){
            ...
            System.out.println("Coal: "+coal+", Iron: "+iron+", Lapis: "+lapis+", Gold: "+iron+", Redstone: "+redstone+", Diamond: "+diamond);
        }else{
            System.out.println("Coal: "+coal+", Iron: "+iron+", Gold: "+iron+", Diamond: "+diamond);
        }
