...
public class GuiCreateFlatWorld2 extends GuiCreateFlatWorld
{
    ...
    public void initGui()
    {
        ...
        buttonList.add(buttonAddLayer = new GuiButton(2, width / 2 - 154, height - 52, 100, 20, (new StringBuilder()).append(StatCollector.translateToLocal("createWorld.customize.flat.addLayer")).append(" (NYI)").toString()));
        buttonList.add(buttonEditLayer = new GuiButton(3, width / 2 - 50, height - 52, 100, 20, (new StringBuilder()).append(StatCollector.translateToLocal("createWorld.customize.flat.editLayer")).append(" (NYI)").toString()));
    ...
    public void drawScreen(int par1, int par2, float par3)
    {
        ...
        GuiButton guibutton;
         for (Iterator iterator = buttonList.iterator(); iterator.hasNext(); guibutton.drawButton(mc, par1, par2))
         {
