...
//             minecraft.entityRenderer = new EntityRenderer2(minecraft);
            ...
            Icon[] destroy = null;
            try{
                destroy = (Icon[])(core.getField(RenderGlobal.class, minecraft.renderGlobal, 26));
            }catch(ClassCastException e){
                optifine = true;
                destroy = (Icon[])(core.getField(RenderGlobal.class, minecraft.renderGlobal, 25));
            }
            minecraft.renderGlobal = new RenderGlobal2(minecraft, minecraft.renderEngine, optifine);
            core.setField(RenderGlobal.class, minecraft.renderGlobal, optifine ? 25 : 26, destroy);
