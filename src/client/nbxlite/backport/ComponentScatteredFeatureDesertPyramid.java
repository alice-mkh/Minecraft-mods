...
public class ComponentScatteredFeatureDesertPyramid extends ComponentScatteredFeature
{
    ...
    public boolean addComponentParts(World par1World, Random par2Random, StructureBoundingBox par3StructureBoundingBox)
    {
        ...
        int k = getMetadataWithOffset(128, 3);
        int i1 = getMetadataWithOffset(128, 2);
        int j1 = getMetadataWithOffset(128, 0);
        int k1 = getMetadataWithOffset(128, 1);
        int l1 = 1;
        byte byte0 = 11;
        ...
        placeBlockAtCurrentPosition(par1World, 128, k, 2, 10, 0, par3StructureBoundingBox);
        placeBlockAtCurrentPosition(par1World, 128, i1, 2, 10, 4, par3StructureBoundingBox);
        placeBlockAtCurrentPosition(par1World, 128, j1, 0, 10, 2, par3StructureBoundingBox);
        placeBlockAtCurrentPosition(par1World, 128, k1, 4, 10, 2, par3StructureBoundingBox);
        ...
        placeBlockAtCurrentPosition(par1World, 128, k, field_56297_a - 3, 10, 0, par3StructureBoundingBox);
        placeBlockAtCurrentPosition(par1World, 128, i1, field_56297_a - 3, 10, 4, par3StructureBoundingBox);
        placeBlockAtCurrentPosition(par1World, 128, j1, field_56297_a - 5, 10, 2, par3StructureBoundingBox);
        placeBlockAtCurrentPosition(par1World, 128, k1, field_56297_a - 1, 10, 2, par3StructureBoundingBox);
        ...
        placeBlockAtCurrentPosition(par1World, 128, k, 2, 4, 5, par3StructureBoundingBox);
        placeBlockAtCurrentPosition(par1World, 128, k, 2, 3, 4, par3StructureBoundingBox);
        placeBlockAtCurrentPosition(par1World, 128, k, field_56297_a - 3, 4, 5, par3StructureBoundingBox);
        placeBlockAtCurrentPosition(par1World, 128, k, field_56297_a - 3, 3, 4, par3StructureBoundingBox);
