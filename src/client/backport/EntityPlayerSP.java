...
public class EntityPlayerSP extends EntityPlayer
{
    ...
    private InventoryEnderChest field_56244_a;

    public InventoryEnderChest func_56242_aN()
    {
        return field_56244_a;
    }

    public EntityPlayerSP(Minecraft par1Minecraft, World par2World, Session par3Session, int par4)
    {
        super(par2World);
        field_56244_a = new InventoryEnderChest();
        sprintToggleTimer = 0;
    ...
    public void writeEntityToNBT(NBTTagCompound par1NBTTagCompound)
    {
        ...
        par1NBTTagCompound.setTag("EnderItems", field_56244_a.func_56215_g());
    }
    ...
    public void readEntityFromNBT(NBTTagCompound par1NBTTagCompound)
    {
        ...
        if (par1NBTTagCompound.hasKey("EnderItems"))
        {
            ...
            field_56244_a.func_56214_a(nbttaglist1);
        }
    }
