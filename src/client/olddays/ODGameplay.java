...
public class ODGameplay extends OldDaysModule{
    ...
    private void setArmorDamage(boolean b){
        ...
        mod_OldDays.setField(net.minecraft.src.Item.class, Item.helmetLeather, 145, b ? 33 << 0 : 55);
        mod_OldDays.setField(net.minecraft.src.Item.class, Item.helmetChain, 145, b ? 33 << 1 : 165);
        mod_OldDays.setField(net.minecraft.src.Item.class, Item.helmetSteel, 145, b ? 33 << 2 : 165);
        mod_OldDays.setField(net.minecraft.src.Item.class, Item.helmetGold, 145, b ? 33 << 4 : 77);
        mod_OldDays.setField(net.minecraft.src.Item.class, Item.helmetDiamond, 145, b ? 33 << 3 : 363);
        mod_OldDays.setField(net.minecraft.src.Item.class, Item.plateLeather, 145, b ? 48 << 0 : 80);
        mod_OldDays.setField(net.minecraft.src.Item.class, Item.plateChain, 145, b ? 48 << 1 : 240);
        mod_OldDays.setField(net.minecraft.src.Item.class, Item.plateSteel, 145, b ? 48 << 2 : 240);
        mod_OldDays.setField(net.minecraft.src.Item.class, Item.plateGold, 145, b ? 48 << 4 : 112);
        mod_OldDays.setField(net.minecraft.src.Item.class, Item.plateDiamond, 145, b ? 48 << 3 : 528);
        mod_OldDays.setField(net.minecraft.src.Item.class, Item.legsLeather, 145, b ? 45 << 0 : 75);
        mod_OldDays.setField(net.minecraft.src.Item.class, Item.legsChain, 145, b ? 45 << 1 : 225);
        mod_OldDays.setField(net.minecraft.src.Item.class, Item.legsSteel, 145, b ? 45 << 2 : 225);
        mod_OldDays.setField(net.minecraft.src.Item.class, Item.legsGold, 145, b ? 45 << 4 : 105);
        mod_OldDays.setField(net.minecraft.src.Item.class, Item.legsDiamond, 145, b ? 45 << 3 : 495);
        mod_OldDays.setField(net.minecraft.src.Item.class, Item.bootsLeather, 145, b ? 39 << 0 : 65);
        mod_OldDays.setField(net.minecraft.src.Item.class, Item.bootsChain, 145, b ? 39 << 1 : 195);
        mod_OldDays.setField(net.minecraft.src.Item.class, Item.bootsSteel, 145, b ? 39 << 2 : 195);
        mod_OldDays.setField(net.minecraft.src.Item.class, Item.bootsGold, 145, b ? 39 << 4 : 91);
        mod_OldDays.setField(net.minecraft.src.Item.class, Item.bootsDiamond, 145, b ? 39 << 3 : 429);
