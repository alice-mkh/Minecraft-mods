...
public class ODEyecandy extends OldDaysModule{
    public ODEyecandy(mod_OldDays c){
        ...
        new OldDaysPropertyBool(this,   3, true,  "OldEndermen").setFallback("olddays/enderman_eyes.png").setRefreshOnFallback();
        ...
        new OldDaysPropertyBool(this,   8, false, "MobArmor").setFallback("olddays/plate.png").setRefreshOnFallback();
    ...
    public void callback (int i){
        switch (i){
            ...
            case 3: set(net.minecraft.src.EntityEnderman.class, "smoke", OldEndermen);
                    set(net.minecraft.src.RenderEnderman2.class, "greeneyes", OldEndermen && hasTextures("olddays/enderman_eyes.png")); break;
            ...
            case 8: set(net.minecraft.src.RenderZombie.class, "mobArmor", MobArmor);
                    ...
                    set(net.minecraft.src.RenderZombie.class, "fallback", !hasTextures("olddays/plate.png"));
                    set(net.minecraft.src.RenderSkeleton.class, "fallback", !hasTextures("olddays/plate.png")); break;
