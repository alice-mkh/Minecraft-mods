...
public class mod_OldDaysTextures extends mod_OldDays{
    ...
    public void callback (int i){
        switch(i){
            case 1: setTextureHook("/terrain.png", 16, "/olddays/textures.png", Cobblestone<2 ? 0 : 1, Cobblestone<3); break;
            case 2: setTextureHook("/terrain.png", 36, "/olddays/textures.png", 2, MossStone); break;
            case 3: setStone(); break;
            case 4: setTextureHook("/terrain.png", 7, "/olddays/textures.png", Brick<2 ? 6 : 7, Brick<3); break;
            ...
            case 9: setTextureHook("/terrain.png", 4, "/olddays/textures.png", Planks<2 ? 4 : 5, Planks<3); break;
            case 10:setTextureHook("/terrain.png", 15, "/olddays/textures.png", Sapling<2 ? 9 : 10, Sapling<3); break;
            ...
            case 28:setTextureHook("/environment/moon_phases.png", "/olddays/moon_phases.png", !Moon); break;
        }
    }
    ...
    private void setOreBlocks(){
        ...
        setTextureHook("/terrain.png", 22, "/olddays/textures.png", 49, OreBlocks<3);
        setTextureHook("/terrain.png", 23, "/olddays/textures.png", 50, OreBlocks<3);
        setTextureHook("/terrain.png", 24, "/olddays/textures.png", 51, OreBlocks<3);
        if (OreBlocks<3){
            reload();
        }
    }
    ...
    private void setCloth(){
        ...
        for (int i = 0; i < 16; i++){
            setTextureHook("/terrain.png", orig[i], "/olddays/textures.png", Wool<2 ? classic[i] : beta[i], Wool<3);
        }
    }
}