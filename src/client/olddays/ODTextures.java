...
public class ODTextures extends OldDaysModule{
    ...
    public void callback (int i){
        switch(i){
            ...
            case 27:setTextureHook("/misc/explosion.png", "/olddays/explosion.png", Explosion && !getFallback()); break;
    ...
    private void setStone(){
        ...
        if (Furnace){
            setTextureHook("/terrain.png", 62, Stone && !getFallback() ? "/olddays/textures.png" : "/terrain.png", Stone && !getFallback() ? 3 : 1, Furnace);
        }
    }
